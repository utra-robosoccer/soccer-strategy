...
#define MW_PACKAGING_MAINTAINERNAME Jason Wang
#define MW_PACKAGING_MAINTAINEREMAIL soccer@utra.ca
#define MW_PACKAGING_LICENSE BSD
#define MW_PACKAGING_VERSION 1.0.0
#define MW_BOARDPARAMETERS_DEVICEADDRESS 192.168.2.21
#define MW_BOARDPARAMETERS_USERNAME vuwij
#define MW_RUNTIME_BUILDACTION 2
#define MW_ROS_INSTALL /opt/ros/kinetic
#define MW_ROS_CATKINWS ~/soccer_ws
