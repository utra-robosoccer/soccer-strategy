...
void soccerbot_initialize(void)
{
  ...
  // External mode info
  soccerbot_M->Sizes.checksums[0] = (10148220U);
  soccerbot_M->Sizes.checksums[1] = (1049394210U);
  soccerbot_M->Sizes.checksums[2] = (2453203262U);
  soccerbot_M->Sizes.checksums[3] = (3987400208U);
